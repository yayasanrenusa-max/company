...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground selection:bg-primary selection:text-white transition-colors duration-300">
      {/* Navbar */}
      <nav className="fixed top-0 z-50 w-full px-6 py-4 glass bg-opacity-30">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            <ThemeToggle />
            <button className="hidden sm:block px-6 py-2 text-sm font-semibold rounded-full bg-primary text-white hover:bg-sky-500 transition-all shadow-[0_0_20px_rgba(14,165,233,0.3)]">
              Let's Talk
            </button>
          </div>
        </div>
      ...
      <main>
        ...
        <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden bg-hero-pattern">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl animate-float">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#services" className="px-8 py-4 bg-foreground text-background font-bold rounded-xl hover:opacity-90 transition-all">
                Explore Services
              </a>
              <a href="#contact" className="px-8 py-4 glass font-bold rounded-xl hover:bg-foreground/5 transition-all border-foreground/10">
                Contact Us
              </a>
            </div>
          </div>
        ...
        <section id="services" className="py-24 px-6 max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-muted max-w-xl mx-auto">Merging modern web architectures with seamless hardware integration to power the next generation of industry.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 text-center sm:text-left">
            <div className="glass p-8 rounded-3xl group hover:border-primary/50 transition-all">
              <div className="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.75 17L9 21l-1 1h8l-1-1-.75-4M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
              </div>
        ...
        {/* Founders Section */}
        <section id="founders" className="py-24 px-6 bg-foreground/[0.02]">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-4">
              <div>
                <h2 className="text-4xl font-bold mb-4">Meet the Visionaries</h2>
                <p className="text-muted max-w-md">Driven by passion, led by innovation. The duo behind our technological breakthroughs.</p>
              </div>
              <div className="h-0.5 flex-1 bg-foreground/5 mx-8 h-px hidden md:block" />
            </div>

            <div className="grid md:grid-cols-2 gap-12">
              {/* Founder 1 */}
              <div className="relative group overflow-hidden rounded-[2.5rem] bg-card border border-foreground/5 shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 p-8 w-full translate-y-4 group-hover:translate-y-0 transition-transform">
                  ...
                  <p className="text-muted text-sm max-w-xs opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <section id="contact" className="py-24 px-6 text-center">
          <div className="glass p-16 rounded-[3rem] max-w-5xl mx-auto relative overflow-hidden shadow-2xl">
            <div className="absolute top-0 right-0 w-64 h-64 bg-primary/20 blur-[100px] rounded-full" />
            <h2 className="text-4xl md:text-6xl font-black mb-8">Ready to Build <br />the Future?</h2>
            <p className="text-muted mb-12 max-w-xl mx-auto text-lg leading-relaxed">
              Whether it's a digital platform or a smart hardware solution, we have the expertise to bring your vision to life.
            </p>
            <button className="px-12 py-5 bg-foreground text-background font-black text-lg rounded-2xl hover:scale-105 transition-all shadow-xl shadow-foreground/5">
              Start Your Project
            </button>
          </div>
        </section>
      ...
      {/* Footer */}
      <footer className="py-12 border-t border-foreground/5 bg-foreground/[0.01] px-6 text-center">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex space-x-6">
            ...
            <a href="#" className="text-muted hover:text-foreground transition-colors">GitHub</a>
